...
public class Contract_Relationship_And_Merge {
    private final Base lBase;

    public Contract_Relationship_And_Merge(@NotNull Base base) {
        this.lBase = base;
    }

    @When("{string} {string} that contains[{string}, {string}] is changed to [{string}, " +
            "{string}] by adding task[{string}, {string}] and {string} user manually merges " +
            "{string} contact after applying relationship at[{string}, {string}, {string}]")
    public void contract_relationship_and_merge(String opp_stage, String opp_name, String proposal_status,
                                                String key_contact, String next_opp_stage, String next_step,
                                                String subject, String contact, @NotNull String user,
                                                String file_name, String relationship, String level, String lodgement_point) {
