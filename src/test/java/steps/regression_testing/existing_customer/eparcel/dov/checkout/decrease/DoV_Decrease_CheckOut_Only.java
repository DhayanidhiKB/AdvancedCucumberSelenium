...
public class DoV_Decrease_CheckOut_Only {
    ...
    @When("{string} after deleting {string} from opportunity[{string}]")
    public void dov_decrease_check_out_only(String check_out_option, String product, String opp_name) {
