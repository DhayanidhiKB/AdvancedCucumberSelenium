...
public class Generate_Agreement_Document {
    ...
    @When("{string} with below details after adding {string} with rk code[{string}] " +
            "to the opportunity[{string}] by validating its attributes {string}, " +
            "{string}, {string}, {string} and lodgement point {string}")
    public void generate_agreement_document(String check_out_option, String product, String opp_name,
                                            String rk_code, String attribute_1, String attribute_2,
