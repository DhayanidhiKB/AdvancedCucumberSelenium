...
Feature: Create Billing Account/Rating Plan ID for EParcel New Customers with Standard Rate Card (Tier 4 to Tier 8) Pricing Points
  ...
  @STE
  Scenario Outline: As a Onboarding user, on-board new StarTrack customer['<org_name>', '<abn>'] using "Generate Manual Agreement Document" belonging to tier['<tier>'] with service type['<service_type>'] and monthly spend['<monthly_spend>']
    ...
    And '<opp_name>' contains "Accepted without proposal document" with contact '<sender>' and merges '<file_name>' with contract documents
    ...
    @PTEST
    Examples:
      | user_type  | org_name                     | abn         | acn | b_street       | b_city  | b_state | b_code | p_street       | p_city  | p_state | p_code | title | first_name             | last_name          | email                         | opp_name                                                                                            | post_code      | monthly_spend | sender                                    | product       | service_type | primary_suburb | suburb         | cart_tier | industry | street_number | file_name                  | no_of_dsr |
      | Onboarding | MCKENZIE SUPERANNUATION FUND | 37158288490 |     | 3 Kenwyn Close | St Ives | NSW     | 2075   | 3 Kenwyn Close | St Ives | NSW     | 2075   | Mr.   | Automation_Tester_1021 | Vinoth_Murali_1021 | vinoth.murali3@auspost.com.au | As Onboarding generate manual agreement document for StarTrack Road Express new customer_31_10_2023 | 3000-MELBOURNE | 11000         | Automation_Tester_1021 Vinoth_Murali_1021 | Premium - STE | PRM          | 3000-MELBOURNE | 3000-MELBOURNE | Tier 4    | B Mining | 3             | PDA-COMPASS-0000000084.pdf | 2         |