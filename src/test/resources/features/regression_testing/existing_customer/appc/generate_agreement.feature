...
Feature: "Create Rating Plan" request is "Submitted" to SAP for APPC Existing Customers belonging to Standard Pricing Points [Tier 4 to Tier 8] skipping proposal generation
  ...
  Proposal generation is skipped by "Generate Agreement Document" while adding pricing points for "APPC" product.
  ...
  @OrganisationLevel
  Scenario Outline: As a '<user_type>' user, on-board existing APPC customer['<org_name>'] belonging to standard pricing tier['<tier>'], price structure Z6, lodgement zones[Capital, Country, Metro] using "Generate Agreement Document" and contract relationship applied at['<relationship>', '<level>']
    ...
    @PTEST
    Examples:
      | user_type  | org_name                      | first_name             | last_name          | opp_name                                                                                     | product                        | evaluated_spend | tier                             | transit_cover | transit_cover_type | sender                                    | no_of_dsr |
      | Onboarding | PETER R CARTER PROVIDENT FUND | Automation_Tester_1111 | Vinoth_Murali_1111 | As Onboarding generate agreement document for APPC existing customer at org level_31_10_2023 | Australia Post Parcel Contract | 20000           | TIER 4 ($20,000.00 - $49,999.99) | 00            | Adhoc              | Automation_Tester_1111 Vinoth_Murali_1111 | 2         |
      | Sales      | Santos (Bawean) Pty Ltd       | Automation_Tester_1112 | Vinoth_Murali_1112 | As Sales generate agreement document for APPC existing customer at org level_31_10_2023      | Australia Post Parcel Contract | 49999.99        | TIER 4 ($20,000.00 - $49,999.99) | 00            | Adhoc              | Automation_Tester_1112 Vinoth_Murali_1112 | 2         |