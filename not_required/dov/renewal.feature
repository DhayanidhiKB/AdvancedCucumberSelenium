...
Feature: Contract Renewal
  ...
  Scenario Outline: Existing StarTrack customer['<org_name>'] having 'Premium - STE' products amends the contract by initiating DoV for adding 'Road Express - STE' products
    ...
    When User initiates "Standard Apttus Renewal" by adding "Road Express - STE" after validating its attributes "EXP", "3000-MELBOURNE", "3000-MELBOURNE", "Tier 4" and "Checkout Only" from "Renewal: <opp_name>"
    And Proposal document "<org_name>__StarTrack Proposal" in "Draft" status is presented to '<sender>' and later "Accepted"
    ...
    Examples:
      ...
      | THE CAPITAL SUPERANNUATION FUND | Vinoth Murali | Tester_02 | StarTrack Contract Renewal Process_30_08_2023 | 3000-MELBOURNE | 11000         | Vinoth Murali Tester_02 |